...
program liebmain
    ...
    do iT=1,30
        ...
        do sw=1,nms/10
            ...
            avg_n_a_up=avg_n_a_up+n_a_up
            avg_n_b_up=avg_n_b_up+n_b_up
            avg_n_c_up=avg_n_c_up+n_c_up
            avg_n_a_dn=avg_n_a_dn+n_a_dn
            avg_n_b_dn=avg_n_b_dn+n_b_dn
            avg_n_c_dn=avg_n_c_dn+n_c_dn          
            deallocate(evl_s)
            
        enddo 

        total_occ_up=(avg_n_a_up+avg_n_b_up+avg_n_c_up)/(unit_cells*(nms/10))
        total_occ_dn=(avg_n_a_dn+avg_n_b_dn+avg_n_c_dn)/(unit_cells*(nms/10))
        total_occ=total_occ_up+total_occ_dn
        write(80,*)temp,avg_n_a_up/(unit_cells*nms/10),avg_n_a_dn/(unit_cells*nms/10),avg_n_b_up/(unit_cells*nms/10)&
        &,avg_n_b_dn/(unit_cells*nms/10),avg_n_c_up/(unit_cells*nms/10),avg_n_c_dn/(unit_cells*nms/10)&
        &,total_occ_up,total_occ_dn,total_occ
        flush(80)
